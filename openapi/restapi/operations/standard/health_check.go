...
type HealthCheckHandlerFunc func(HealthCheckParams, *models.Principal) HealthCheckResponder

// Handle executing the request and returning a response
func (fn HealthCheckHandlerFunc) Handle(params HealthCheckParams, principal *models.Principal) HealthCheckResponder {
	return fn(params, principal)
}

// HealthCheckHandler interface for that can handle valid health check params
type HealthCheckHandler interface {
	Handle(HealthCheckParams, *models.Principal) HealthCheckResponder
}
